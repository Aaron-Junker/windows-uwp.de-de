...
APIs mit [DualApiPartition](/uwp/api/Windows.Foundation.Metadata.DualApiPartitionAttribute) werden in allen Desktop-Apps unterstützt – dies schließt Apps mit und ohne Paketidentität ein. Um festzustellen, ob eine API unterstützt wird, die du aus deiner Desktopanwendung aufrufen möchtest, kannst du dir in der [Referenzdokumentation für WinRT-Namespaces](/uwp/api/) den Referenzartikel zur betreffenden Klasse bzw. dem betreffenden Member ansehen. Dann überprüfst du, ob der Abschnitt **Attribute** im Referenzartikel das Attribut [DualApiPartition](/uwp/api/Windows.Foundation.Metadata.DualApiPartitionAttribute) einschließt.
