...
ms.locfileid: "99069177"
---
# <a name="features-and-technologies-for-windows-apps"></a>Features und Technologien für Windows-Apps

Unabhängig davon, welche Art von App Sie entwickeln oder welches Gerät Sie als Ziel haben, unterstützt Windows viele Features, die zentrale Bausteine für wichtige App-Szenarien darstellen. Einige dieser Features werden für Windows-Runtime (WinRT) und die universelle Windows-Plattform (UWP), Win32 (Windows-API) sowie andere App-Plattformen auf unterschiedliche Weise verfügbar gemacht. In den folgenden Artikeln erfahren Sie, wie bestimmte wichtige Windows-Features auf unterschiedlichen App-Plattformen unterstützt werden und wie Sie diese Features in Ihrem Code verwenden.

Dieser Artikel enthält eine angepasste Liste von Artikeln, in denen Sie erfahren, wie Sie auf den Plattformen WinRT, Win32 (Windows API), WPF und Windows Forms auf wichtige Windows-Features und -Technologien zugreifen können. Vollständige Informationen zu den Entwicklungsfeatures der einzelnen Plattformen finden Sie in den folgenden Ressourcen:

* [Dokumentation zu WinRT/UWP](/windows/uwp/index)
...
Die folgenden Abschnitte enthalten nützliche Links, um mehr über die Integration von Windows-Kernfeatures und -technologien von unseren wichtigsten App-Plattformen zu erfahren: WinRT/UWP, Win32 (Windows API), WPF und Windows Forms.
...
|  WinRT/UWP  |  Win32 (Windows-API) |  WPF  |  Windows Forms  |
|-------|----------------------|-------|-----------------|
| [Sicherheit in Power BI](/windows/uwp/security)<br/><br/>[Authentifizierung und Benutzeridentität](/windows/uwp/security/authentication-and-user-identity)<br/><br/>[Web Account Manager](/windows/uwp/security/web-account-manager)<br/><br/>[Webauthentifizierungsbroker](/windows/uwp/security/web-authentication-broker)<br/><br/>[Kryptografie](/windows/uwp/security/cryptography) | [Sicherheit und Identität](/windows/win32/security)<br/><br/>[Authentifizierung](/win32/secauthn/authentication-portal)<br/><br/>[Kryptografie](/windows/win32/seccng/cng-portal) |  [Sicherheit in .NET](/dotnet/standard/security/)<br/><br/>[Sicherheit (WPF)](/dotnet/desktop/wpf/security-wpf)  |  [Sicherheit in .NET](/dotnet/standard/security/)<br/><br/>[Sicherheit in Windows Forms](/dotnet/desktop/winforms/windows-forms-security)  |

### <a name="debugging-and-performance"></a>Debugging und Leistung

|  WinRT/UWP  |  Win32 (Windows-API) |  WPF und Windows Forms  |
|-------|----------------------|-------|-----------------|
