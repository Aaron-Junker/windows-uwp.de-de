...
description: Zeigen Sie eine Tabelle mit den Sprachen und entsprechenden Sprachcodes an, die für das Senden von apps an den Microsoft Store unterstützt werden.
...
Dies sind die Sprachen, die von der Microsoft Store unterstützt werden. Ihre APP muss mindestens eine dieser Sprachen unterstützen. 

Sprachcodes, die hier nicht enthalten sind, werden vom Speicher nicht unterstützt. Es wird empfohlen, dass Sie keine Pakete einschließen, die auf andere Sprachcodes abzielen als die unten aufgeführten. Diese Pakete werden nicht an Kunden verteilt und können Verzögerungen oder Fehler bei der Zertifizierung verursachen.
...
| Aserbaidschanisch           | AZ-Arabisch, AZ-Arab-AZ, az-Cyrl, az-Cyrl-AZ, AZ-Latn, AZ-Latn-AZ                                                                                                                                     |
