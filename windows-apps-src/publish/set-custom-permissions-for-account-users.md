...
|-------------------------------------------------------|----------------------------------|----------------------------------|----------------------------------|----------------------------|---------------------------|----------------------------------|
|    Lizenzerwerbs-Bericht (einschließlich nahezu in Echtzeit Daten) |    Kann anzeigen                      |    Kann anzeigen                      |    Kein Zugriff                     |    Kein Zugriff               |    Kann anzeigen               |    Kein Zugriff                     |
...
|    Bericht zur Integrität (einschließlich nahezu in Echtzeit Daten)      |    Kann anzeigen                      |    Kann anzeigen                      |    Kann anzeigen                      |    Kann anzeigen                |    Kein Zugriff              |    Kein Zugriff                     |
...
<tr><td align="left">    <b>Leistungsbericht für die Kontoebene ad</b> </td><td align="left">  Kann den <a href="advertising-performance-report.md">Bericht zur Anzeigenleistung auf Kontoebene</a> anzeigen.      </td><td align="left">  Nicht zutreffend   </td></tr>
...
<tr><td align="left">    <b>Berichte zu AD Vermittlung</b>                </td><td align="left">  Kann den <a href="ad-mediation-report.md">Bericht zur Anzeigenvermittlung</a> für alle Produkte des Kontos anzeigen.    </td><td align="left">  Nicht zutreffend    </td></tr>
...
<tr><td align="left">    <b>Fügt ein Leistungsberichte</b>      </td><td align="left">  Kann den <a href="affiliates-performance-report.md">Bericht zur Partneranzeigenleistung</a> für alle Produkte des Kontos anzeigen.   </td><td align="left">  Nicht zutreffend   </td></tr>
<tr><td align="left">    <b>Ads-Berichte für App-Installation</b>             </td><td align="left">  Können den <a href="promote-your-app-report.md">Bericht „Anzeigenkampagne“</a> anzeigen.           </td><td align="left">  Nicht zutreffend   </td></tr>
...
<tr><td align="left">    <b>Store-Verkaufsereignisse</b>&nbsp;*                            </td><td align="left">  Nicht zutreffend    </td><td align="left">  Kann die Option konfigurieren, automatisch Produkte im Store in Verkaufsereignisse aufzunehmen.     </td></tr>
...
<table>
    ...
    <tbody>
    <tr><td align="left">    <b>Akquisitionen</b> (einschließlich nahezu in Echtzeit Daten) </td><td>    Kann die Berichte <a href="acquisitions-report.md">Käufe</a> und <a href="add-on-acquisitions-report.md">Add-On-Käufe</a> für das Produkt anzeigen.        </td><td>    Nicht zutreffend    </td><td>    N/v (Einstellungen für übergeordnetes Produkt umfassen die **-Add-On Akquisitionen** Bericht)        </td><td>    Nicht zutreffend                         </td></tr>
    <tr><td align="left">    <b>Verwendung</b> </td><td>    Kann den <a href="usage-report.md">Bericht „Nutzung“</a> für das Produkt anzeigen.     </td><td>    Nicht zutreffend       </td><td>    Nicht zutreffend     </td><td>    Nicht zutreffend         </td></tr>
    <tr><td align="left">    <b>Integrität</b> (einschließlich nahezu in Echtzeit Daten) </td><td>    Kann den <a href="health-report.md">Bericht „Integrität“</a> für das Produkt anzeigen.    </td><td>    Nicht zutreffend     </td><td>    Nicht zutreffend     </td><td>    Nicht zutreffend         </td></tr>
    ...
    <tr><td align="left">    <b>Xbox-Analysen</b> </td><td>    Sehen die <a href="xbox-analytics-report.md">Xbox-Analysebericht</a> für das Produkt.    </td><td>    Nicht zutreffend   </td><td>    Nicht zutreffend       </td><td>    Nicht zutreffend          </td></tr>
    </tbody>
    </table>
...
<table>
    ...
    <tr><td align="left">    <b>Ziel-Angebote</b>     </td><td>    Kann die <a href="use-targeted-offers-to-maximize-engagement-and-conversions.md">zielgerichteten Angebote</a> für das Produkt sehen.         </td><td>    Kann <a href="use-targeted-offers-to-maximize-engagement-and-conversions.md">zielgerichtete Angebote</a> für das Produkt erstellen, verwalten und anzeigen.          </td><td>    Nicht zutreffend     </td><td>    Nicht zutreffend      </td></tr>
...
<table>
    ...
    <tbody>
    <tr><td align="left">    <b>Produkt-Setup</b>  </td><td>    Können die Setupseite der Product-Produkte anzeigen.     </td><td>    Anzeigen und bearbeiten die Setupseite der Product-Produkte können. </td><td>    Sie sehen die Setupseite der Produkt-Add-Ons.   </td><td>    Kann anzeigen und bearbeiten Sie die Produkt-Setup-Seite Add-ons.          </td></tr>
    <tr><td align="left">    <b>Preise und Verfügbarkeit</b>  </td><td>    Sehen die <a href="set-app-pricing-and-availability.md">Preise und Verfügbarkeit</a> auf der Seite Produkte.     </td><td>    Anzeigen und Bearbeiten der <a href="set-app-pricing-and-availability.md">Preise und Verfügbarkeit</a> auf der Seite Produkte. </td><td>    Sehen die <a href="set-add-on-pricing-and-availability.md">Preise und Verfügbarkeit</a> -Add-Ons auf der Seite.   </td><td>    Anzeigen und Bearbeiten der <a href="set-add-on-pricing-and-availability.md">Preise und Verfügbarkeit</a> -Add-Ons auf der Seite.          </td></tr>
    <tr><td align="left">    <b>Eigenschaften</b>   </td><td>    Sehen die <a href="enter-app-properties.md">Eigenschaften</a> auf der Seite Produkte.      </td><td>    Anzeigen und Bearbeiten der <a href="enter-app-properties.md">Eigenschaften</a> auf der Seite Produkte.       </td><td>    Sehen die <a href="enter-add-on-properties.md">Eigenschaften</a> -Add-Ons auf der Seite.     </td><td>    Anzeigen und Bearbeiten der <a href="enter-add-on-properties.md">Eigenschaften</a> -Add-Ons auf der Seite.               </td></tr>
    <tr><td align="left">    <b>Altersfreigaben</b>    </td><td>    Sehen die <a href="age-ratings.md">Age Bewertungen</a> auf der Seite Produkte.       </td><td>    Anzeigen und Bearbeiten der <a href="age-ratings.md">Age Bewertungen</a> auf der Seite Produkte.    </td><td>    Können die Age-Bewertungen-Seite des Add-ons anzeigen.          </td><td>     Kann anzeigen und bearbeiten Sie die ALTER-Bewertungen-Seite von Add-ons.       </td></tr>
    <tr><td align="left">    <b>Pakete</b>        </td><td>    Sehen die <a href="upload-app-packages.md">Pakete</a> auf der Seite Produkte.  </td><td>    Anzeigen und Bearbeiten der <a href="upload-app-packages.md">Pakete</a> auf der Seite Produkte, einschließlich Hochladen von Paketen.     </td><td>   Sehen die <a href="upload-app-packages.md">Pakete</a> Add-Ons (falls zutreffend) auf der Seite.   </td><td>     Anzeigen und bearbeiten können <a href="upload-app-packages.md">Pakete</a> Add-Ons (falls zutreffend) auf der Seite.             </td></tr>
    <tr><td align="left">    <b>Store-Angebote</b>  </td><td>    Sehen die <a href="create-app-store-listings.md">Store auflisten Seite(n)</a> Produkte.  </td><td>    Anzeigen und bearbeiten können die <a href="create-app-store-listings.md">Store auflisten Seite(n)</a> Produkte an, und Sie können neue Store-Angebote für verschiedene Sprachen hinzufügen.     </td><td>    Sehen die <a href="create-add-on-store-listings.md">Store auflisten Seite(n)</a> Add-Ons.            </td><td>    Anzeigen und Bearbeiten der <a href="create-add-on-store-listings.md">Store auflisten Seite(n)</a> von Add-ons und Store-Angebote für verschiedene Sprachen hinzufügen.                 </td></tr>
    ...
    <tr><td align="left">    <b>Neuen Add-Ons</b>    </td><td>    Es wird kein Zugriff gewährt, wenn diese Berechtigung als schreibgeschützt festgelegt ist. </td><td>    Kann neue <a href="set-your-add-on-product-id.md">Add-Ons</a> für das Produkt erstellen. </td><td>    Nicht zutreffend    </td><td>    Nicht zutreffend        </td></tr>
    ...
    <tr><td align="left">    <b>CD-ROM-Anforderung</b>   </td><td>    Kann anzeigen, die die Request-Seite disc. </td><td>    CD-ROM-Anforderungen können erstellt werden. </td><td>   Nicht zutreffend    </td><td>   Nicht zutreffend          </td></tr>
    <tr><td align="left">    <b>CD-ROM Lizenzgebühren </b>   </td><td>    Kann anzeigen, die die Lizenzgebühren Seite disc.</td><td>    CD-ROM Lizenzgebühren können erstellt werden. </td><td>   Nicht zutreffend    </td><td>   Nicht zutreffend          </td></tr>
    </tbody>
    </table>
...
<table>
    ...
    <tbody>
    <tr><td align="left">    <b>Vertrauende Seiten</b>&nbsp;*</td><td>    Können die Seite der vertrauenden Seite Parteien eines Kontos anzeigen.   </td><td>    Kann anzeigen und bearbeiten die Parteien der vertrauenden Seite (Seite) für ein Konto.    </td><td>    Nicht zutreffend    </td><td>    Nicht zutreffend                      </td></tr>
    <tr><td align="left">    <b>Partnerdienste</b>&nbsp;*</td><td>    Kann die Webseite für die Dienste eines Kontos anzeigen.  </td><td>    Kann anzeigen und bearbeiten Sie die Web Services-Seite für ein Konto.      </td><td>    Nicht zutreffend    </td><td>    Nicht zutreffend                      </td></tr>
    <tr><td align="left">    <b>Xbox-Testkonten</b>&nbsp;*</td><td>    Sie sehen die Xbox-Kontoseite für ein Konto.  </td><td>    Kann anzeigen und bearbeiten die Xbox-Kontoseite für ein Konto.    </td><td>    Nicht zutreffend    </td><td>    Nicht zutreffend                      </td></tr>
    <tr><td align="left">    <b>Xbox-Testkonten pro Sandbox</b>&nbsp;*</td><td>    Können die Xbox-Kontoseite für nur die angegebenen Sandboxes eines Kontos anzeigen.  </td><td>    Kann anzeigen und bearbeiten Sie den Test für die Xbox.   <tr><td align="left">    <b>Seite "Konten" für die nur die angegebenen Sandboxes eines Kontos    </td><td>    Nicht zutreffend    </td><td>    Nicht zutreffend                      </td></tr>
    <tr><td align="left">    <b>Xbox-Geräte</b>&nbsp;*</td><td>    Können die Xbox eine Konsolen-entwicklungsseite eines Kontos anzeigen.  </td><td>    Anzeigen und bearbeiten die Xbox eine Konsolen-entwicklungsseite eines Kontos können.    </td><td>    Nicht zutreffend    </td><td>    Nicht zutreffend                      </td></tr>
    <tr><td align="left">    <b>Xbox-Geräte pro Sandbox</b>&nbsp;*</td><td>    Können die Xbox eine Konsolen-entwicklungsseite für nur die angegebenen Sandboxes eines Kontos anzeigen.  </td><td>    Anzeigen und bearbeiten die Xbox eine Konsolen-entwicklungsseite für nur die angegebenen Sandboxes eines Kontos können.    </td><td>    Nicht zutreffend    </td><td>    Nicht zutreffend                      </td></tr>
    ...
    <tr><td align="left">    <b>Dienstkonfiguration</b>&nbsp;*</td><td>    Können die Xbox Live-Dienst-Konfigurationsseite eines Produkts anzeigen.  </td><td>    Kann anzeigen und bearbeiten die Xbox Live-Dienst-Konfigurationsseite eines Produkts.    </td><td>    Nicht zutreffend    </td><td>    Nicht zutreffend                      </td></tr>
    <tr><td align="left">    <b>Tools-Zugriff</b>&nbsp;*</td><td>    Xbox Live-Tools können auf einem Produkt zum Anzeigen von Daten ausgeführt werden.  </td><td>    Führen Sie Xbox Live-Tools können auf einem Produkt anzeigen und Bearbeiten von Daten.    </td><td>    Nicht zutreffend    </td><td>    Nicht zutreffend                      </td></tr>
</tbody>
</table>
