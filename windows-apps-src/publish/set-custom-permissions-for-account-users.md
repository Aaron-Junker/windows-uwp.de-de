...
| Entwickler            | Kann Pakete hochladen und Apps und Add-Ons einreichen sowie den [Nutzungsbericht](usage-report.md) für Telemetriedetails einsehen. Kann auf [Geräte übergreifende](https://go.microsoft.com/fwlink/?linkid=874042) Funktionen zugreifen. Kann keine finanziellen Informationen oder Kontoeinstellungen anzeigen.   |
...
- **Kein Zugriff**: Der Benutzer verfügt nicht über die entsprechende Berechtigung.
- Schreib **geschützt:** Der Benutzer kann auf Features anzeigen, die sich auf den jeweiligen Bereich beziehen, kann jedoch keine Änderungen vornehmen. 
- **Lese-** /Schreibzugriff: Der Benutzer erhält Zugriff, um Änderungen im Zusammenhang mit dem Bereich vorzunehmen und ihn anzuzeigen.
- **Gemischt**: Diese Option kann nicht direkt ausgewählt werden, aber der **gemischte** Indikator zeigt an, ob Sie eine Kombination aus Zugriff für diese Berechtigung zugelassen haben. Wenn Sie z. B. **Schreibgeschützt** bei **Preise und Verfügbarkeit** für **Alle Produkte** festlegen, anschließend jedoch **Lese-/Schreibzugriff** auf **Preise und Verfügbarkeit** für ein bestimmtes Produkt gewähren, wird für **Preise und Verfügbarkeit** unter **Alle Produkte** „Gemischt“ angezeigt. Dasselbe gilt, wenn für einige Produkte als Berechtigung **Kein Zugriff** festgelegt ist, für andere jedoch **Lese-/Schreibzugriff** und/oder **Schreibgeschützt**.
...
<tr><td align="left">    <b>AD-Vermittlung</b>                        </td><td align="left">  Kann AD-Vermittlungs Konfigurationen für alle Produkte im Konto anzeigen.    </td><td align="left">  Können die Konfigurationen der AD-Vermittlung für alle Produkte im Konto anzeigen und ändern.        </td></tr>
<tr><td align="left">    <b>AD-Vermittlungs Berichte</b>                </td><td align="left">  Kann den <a href="ad-mediation-report.md">Bericht zur Anzeigenvermittlung</a> für alle Produkte des Kontos anzeigen.    </td><td align="left">  Nicht zutreffend    </td></tr>
...
<tr><td align="left">    <b>Leistungsberichte zu Unternehmen</b>      </td><td align="left">  Kann den <a href="affiliates-performance-report.md">Bericht zur Partneranzeigenleistung</a> für alle Produkte des Kontos anzeigen.   </td><td align="left">  Nicht zutreffend   </td></tr>
<tr><td align="left">    <b>App-Installations Anzeige Berichte</b>             </td><td align="left">  Können den <a href="promote-your-app-report.md">Bericht „Anzeigenkampagne“</a> anzeigen.           </td><td align="left">  Nicht zutreffend   </td></tr>
...
Berechtigungen auf Produktebene sind in vier Kategorien unterteilt: **Analyse**, **Monetarisierung**, **Veröffentlichung**und **Xbox Live**. Sie können die einzelnen Kategorien erweitern, um die jeweiligen Berechtigungen anzuzeigen. Sie haben auch die Option **Alle Berechtigungen** für einen oder mehrere bestimmte Produkte zu aktivieren.
...
<table>
    ...
    <tr><td align="left">    <b>Gezielte Angebote</b>     </td><td>    Kann die <a href="use-targeted-offers-to-maximize-engagement-and-conversions.md">zielgerichteten Angebote</a> für das Produkt sehen.         </td><td>    Kann <a href="use-targeted-offers-to-maximize-engagement-and-conversions.md">zielgerichtete Angebote</a> für das Produkt erstellen, verwalten und anzeigen.          </td><td>    Nicht zutreffend     </td><td>    Nicht zutreffend      </td></tr>
    ...
    <tr><td align="left">    <b>Eller</b></td><td>    Kann <a href="../monetize/run-app-experiments-with-a-b-testing.md">Experimente (A/B-Tests)</a> sowie Experimentdaten für das Produkt anzeigen.   </td><td>    Kann <a href="../monetize/run-app-experiments-with-a-b-testing.md">Experimente (A/B-Tests)</a> für das Produkt erstellen, verwalten und anzeigen sowie Experimentdaten anzeigen.     </td><td>    Nicht zutreffend  </td><td>    Nicht zutreffend                 </td></tr>
...
<table>
    ...
    <tr><td align="left">    <b>Neue Add-ons</b>    </td><td>    Es wird kein Zugriff gewährt, wenn diese Berechtigung als schreibgeschützt festgelegt ist. </td><td>    Kann neue <a href="set-your-add-on-product-id.md">Add-Ons</a> für das Produkt erstellen. </td><td>    Nicht zutreffend    </td><td>    Nicht zutreffend        </td></tr>
...
<table>
    ...
    <tr><td align="left">    <b>Zugriff auf Tools</b>&nbsp;*</td><td>    Kann Xbox Live-Tools für ein Produkt ausführen, um nur Daten anzuzeigen.  </td><td>    Kann Xbox Live-Tools auf einem Produkt ausführen, um Daten anzuzeigen und zu bearbeiten.    </td><td>    Nicht zutreffend    </td><td>    Nicht zutreffend                      </td></tr>
</tbody>
</table>
