...
| Fehler                   | Die Zahlung ist aufgrund eines Microsoft-Systemfehlers fehlgeschlagen.                                                                                         | Weitere Informationen erhalten Sie vom [Microsoft Support](https://developer.microsoft.com/windows/support) .                      |
...
|--------------------------------|------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------|
| earningid                      | Eindeutiger Bezeichner für jedes Einkommen                                                                                                       | Alle                                                            |
| participantid                  | Die primäre Identität des Partners, der sich unter dem Programm verdient                                                                            | Alle                                                            |
| participantidtype              | Hauptsächlich Programm-ID für Incentive-Programme und Verkäufer, wenn für Store-Programme und Azure Marketplace                                          | Alle                                                            |
| participantName                | Name des Erwerbs Partners                                                                                                              | Alle                                                            |
| partnercountrycode             | Standort/Land des Erwerbs Partners                                                                                                  | Alle                                                            |
| Program Name                    | Name des Incentive/Store-Programms                                                                                                             | Alle                                                            |
| transactionId                  | Eindeutiger Bezeichner für die Transaktion                                                                                                    | Alle                                                            |
| transaktioncurrency            | Währung, in der die ursprüngliche Kunden Transaktion aufgetreten ist (Dies ist keine Währung für den Partnerstandort)                                     | Alle                                                            |
| TransactionDate                | Datum der Transaktion. Nützlich für Programme, bei denen viele Transaktionen zu einem Verdienst beitragen                                           | Alle                                                            |
| transaktionexchangerate        | Wechselkurs Datum zum Anzeigen der entsprechenden Transaktion in USD                                                                 | Alle                                                            |
| transaktionamount              | Transaktionsbetrag in der ursprünglichen Transaktionswährung, je nachdem, welche Einnahmen generiert werden                                              | Alle                                                            |
| transaktionsetusd           | Transaktionsbetrag in USD                                                                                                                | Alle                                                            |
| Tor                          | Gibt die Geschäftsregel für den Verdienst an.                                                                                                  | Alle                                                            |
| earningrate                    | Auf Transaktionsbetrag angewendete Incentive-Rate zum Generieren eines Erwerbs                                                                      | Alle                                                            |
| quantity                       | Variiert je nach Programm. Gibt die in Rechnung gestellte Menge für Transaktions Programme an.                                                            | Alle                                                            |
| quantitytype                   | Gibt den Typ der Menge an, z. b. berechnete Menge, Mau                                                                             | Alle                                                            |
| earningtype                    | Gibt an, ob es sich um Gebühr, Rabatt, Coop, Sell usw. handelt.                                                                                          | Alle                                                            |
| earningamount                  | Betrag in der ursprünglichen Transaktionswährung                                                                                      | Alle                                                            |
| earningamountusd               | Betrag in USD                                                                                                                    | Alle                                                            |
| earningdate                    | Datum des Erwerbs                                                                                                                      | Alle                                                            |
| calculationdate                | Datum, an dem das Verdienst im System berechnet wurde                                                                                            | Alle                                                            |
| earningexchangerate            | Wechselkurs, der zum Anzeigen des entsprechenden USD Amount verwendet wird                                                                                  | Alle                                                            |
| exchangeratedate               | Zum Berechnen von "earningamount USD" verwendetes Wechselkurs Datum                                                                                   | Alle                                                            |
| paymentpaytwotax             | Betrag (ohne Steuern) in Zahlen an Währungen für "Gesendete" Zahlungen                                                                 | Alle                                                            |
| paymentcurrency                | Bezahlen Sie die Währung, die vom Partner im Zahlungsprofil gewählt wurde. Nur für gesendete Zahlungen angezeigt                                                   | Alle                                                            |
| paymentexchangerate            | Wechselkurs zur Berechnung von paymentpaytwotax in der Zahlungswährung mithilfe von exchangeratedate                                            | Alle                                                            |
...
| paymentstatus Description       | Benutzerfreundliche Beschreibung des Zahlungsstatus                                                                                                   | Alle                                                            |
...
| productName                    | Mit Transaktion verknüpfter Produktname                                                                                                       | Alle                                                            |
...
| beitragen                       | Arbeitsauslastung                                                                                                                                 | Incentive: nur einige Programme                                 |
...
| Product ID              | Eindeutige Produkt-ID.                                                                                                                                              |
...
| Payment (Zahlung)                 | App-Erlöse abzüglich aller geltenden Steuereinbehaltungen (Betrag angezeigt in Transaktionswährung). (Nicht enthalten in der **reservierten** .csv-Datei.)                               |
