...
ms.locfileid: "80759428"
---
# <a name="set-up-your-payout-account-and-tax-forms"></a>Einrichten von Auszahlungskonten und Steuerformularen

> [!NOTE]
> Wenden Sie sich an den Support, wenn Sie [nach Unterstützung](https://partner.microsoft.com/support)bezüglich der Auszahlungen suchen möchten, einschließlich der Konfiguration von Auszahlungs Konten, fehlender Auszahlungen, dem Aufbewahren von Auszahlungen oder sonstigen anderen.
...
- **Welche PayPal-Einstellungen benötige ich, um Zahlungen zu erhalten?** Sie müssen sicherstellen, dass Ihr PayPal-Konto keine Zahlungen per eCheck blockiert. Diese Einstellung wird über die PayPal-Seite für die bevorzugte Überweisungsmethode verwaltet. Weitere Informationen finden Sie auf der [PayPal-Seite zum Einrichten des Kontos](https://developer.paypal.com/webapps/developer/docs/classic/admin/setup-account/).
