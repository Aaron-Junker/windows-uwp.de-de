---
description: Eine gute Beschreibung kann dazu führen, dass Ihre APP im Microsoft Store steht und Kunden dazu ermutigt, Sie herunterzuladen.
title: Erstellen einer interessanten App-Beschreibung
ms.assetid: E477E98E-090A-4ACE-832F-A98D273EFCA0
ms.date: 10/31/2018
ms.topic: article
keywords: Windows 10, UWP, Description, Description, Store-Auflistung, Marketing
...
ms.locfileid: "93034913"
---
# <a name="write-a-great-app-description"></a>Erstellen einer interessanten App-Beschreibung


Eine gute Beschreibung kann dazu führen, dass Ihre APP im Microsoft Store steht und Kunden dazu ermutigt, Sie herunterzuladen. [Die Beschreibung, die Sie beim Übermitteln der App eingeben](create-app-store-listings.md#description), wird im Store-Eintrag Ihrer App angezeigt. Die ersten Zeilen dieses Texts können auch in Suchergebnissen und Algorithmuslisten im Store angezeigt werden.
...
-   **Verwenden Sie Listen und kurze Absätze.** Potenzielle Kunden werfen u. U. nur einen kurzen Blick auf die Beschreibung Ihrer App. Erleichtern Sie das Überfliegen, indem Sie den Inhalt in kurzen Absätzen und Listen zusammenfassen.
    ...
    > [!NOTE]
    > Durch das Hinzufügen einer Liste von [Produkt Features](create-app-store-listings.md#product-features) können Sie auch schnell anzeigen, was Ihre APP tut. Diese Liste wird direkt unter der App-Beschreibung angezeigt.
