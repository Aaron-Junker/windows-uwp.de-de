...
ms.locfileid: "57635785"
---
# <a name="about-community-ads"></a>Informationen zu Community-Anzeigen

Wenn Ihre app [zeigt Banner oder interstitial Werbebanner](../monetize/display-ads-in-your-app.md), können Sie Cross-heraufstufen Ihrer app mit anderen Entwicklern mit apps in der Microsoft Store kostenlos. Dieses Feature wird *Community-Anzeigen* genannt.  

Das funktioniert wie folgt:

* Nachdem Sie zum Anzeigen der Community teilnehmen wie unten beschrieben, können Sie [erstellen Sie eine kostenlose Community-Ad-Kampagne](create-an-ad-campaign-for-your-app.md). Ihre app wird dann Werbe-Ad-Bereich für andere Entwickler freigeben, die auch zum Community von werbeeinblendungen in zu aktivieren. In Ihrer App werden Anzeigen für Apps anderer Entwickler angezeigt, die an Community-Anzeigen teilnehmen. Im Gegenzug werden in deren Apps Anzeigen für Ihre App angezeigt.
...
Bevor Sie eine Community-Ad-Kampagne für eine Ihrer apps erstellen können, anmelden, Sie müssen dies auf die **Monetize** &gt; **In-app-Werbung** auf der Seite [Partner Center](https://partner.microsoft.com/dashboard).

Zum Anzeigen der Community für UWP-Apps aktivieren:

1. Wählen Sie eine Ad-Einheit, die Sie in der app verwenden, und führen Sie einen Bildlauf nach unten zum **Vermittlung Einstellungen**.
2. Wenn **Teilen Sie Microsoft optimieren die Einstellungen meines** wird ausgewählt, Community-Werbung für Ihre Ad-Komponententests automatisch aktiviert. Wählen Sie andernfalls die baselinekonfiguration oder eine marktspezifische-Konfiguration in der **Ziel** Dropdownliste aus, und überprüfen Sie dann die **Microsoft Community-werbeeinblendungen** im Feld der **anderen Ad-Netzwerken** Liste.

    > [!NOTE]
    > Sie können die **Gewichtung** Felder, geben Sie das Verhältnis von Werbung über kostenpflichtige Netzwerke und anderen Ad-Netzwerken, einschließlich der Community anzeigen angezeigt werden sollen.
