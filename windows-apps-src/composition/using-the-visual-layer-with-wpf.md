...
ms.locfileid: "58174129"
---
# <a name="using-the-visual-layer-with-wpf"></a>Mithilfe der visuellen Ebene mit WPF

Sie können Windows-Runtime-Kompositions-APIs verwenden (so genannte der [visueller Ebene](visual-layer.md)) in Ihren Windows Presentation Foundation (WPF)-apps auf moderne Funktionen für Windows 10-Benutzern das einfache erstellen.
...
![Die ausgeführte app-Benutzeroberfläche](images/interop/wpf-comp-interop-app-ui.png)
