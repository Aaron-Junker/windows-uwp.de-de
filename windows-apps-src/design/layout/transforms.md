...
description: Erfahren Sie, wie mithilfe von Transformationen in der Windows-Runtime &\#160; API, durch Ändern der relativen Koordinatensysteme von Elementen in der Benutzeroberfläche.
ms.date: 02/08/2017
ms.topic: article
...
**Hinweis der Migration:**  Windows Presentation Foundation (WPF)-hatte eine **LayoutTransform** -Eigenschaft, die Transformationen vor dem Layoutdurchlauf angewendet. Windows-Runtime-XAML unterstützt jedoch keine **LayoutTransform**-Eigenschaft. (In Microsoft Silverlight war diese Eigenschaft auch nicht vorhanden.)

## <a name="span-idapplyingatransformtoauielementspanspan-idapplyingatransformtoauielementspanspan-idapplyingatransformtoauielementspanapplying-a-transform-to-a-ui-element"></a><span id="Applying_a_transform_to_a_UI_element"></span><span id="applying_a_transform_to_a_ui_element"></span><span id="APPLYING_A_TRANSFORM_TO_A_UI_ELEMENT"></span>Anwenden einer Transformation auf ein Element der Benutzeroberfläche
...
## <a name="span-idothertransformpropertiesspanspan-idothertransformpropertiesspanspan-idothertransformpropertiesspanother-transform-properties"></a><span id="Other_transform_properties"></span><span id="other_transform_properties"></span><span id="OTHER_TRANSFORM_PROPERTIES"></span>Andere Transformationseigenschaften

-   [**Brush.Transform**](https://msdn.microsoft.com/library/windows/apps/BR228082), [ **Brush.RelativeTransform**](https://msdn.microsoft.com/library/windows/apps/BR228080): Dieser Einfluss wie eine [ **Pinsel** ](/uwp/api/Windows.UI.Xaml.Media.Brush) verwendet Zielkoordinatenbereich innerhalb des Bereichs, der **Pinsel** wird angewendet, um die visuellen Eigenschaften wie z. B.-vordergründen und Hintergründe festlegen. Diese Transformationen sind für die meisten gängigen Brush-Elemente (mit denen normalerweise Volltonfarben mit [**SolidColorBrush**](https://msdn.microsoft.com/library/windows/apps/BR242962) festgelegt werden) zwar nicht relevant, sie können jedoch beim Zeichnen in Bereichen mit einem [**ImageBrush**](https://msdn.microsoft.com/library/windows/apps/BR210101)- oder [**LinearGradientBrush**](https://msdn.microsoft.com/library/windows/apps/BR210108)-Element hilfreich sein.
-   [**Geometry.Transform**](https://msdn.microsoft.com/library/windows/apps/BR210066): Sie können diese Eigenschaft verwenden, um auf eine Geometry-Instanz vor der Verwendung dieser Geometrie für eine Transformation anwenden einer [ **Path.Data** ](https://msdn.microsoft.com/library/windows/apps/BR243356) -Eigenschaftswert.
...
## <a name="span-idaccountingforcoordinateframesofreferenceatruntimespanspan-idaccountingforcoordinateframesofreferenceatruntimespanspan-idaccountingforcoordinateframesofreferenceatruntimespanaccounting-for-coordinate-frames-of-reference-at-run-time"></a><span id="Accounting_for_coordinate_frames_of_reference_at_run_time"></span><span id="accounting_for_coordinate_frames_of_reference_at_run_time"></span><span id="ACCOUNTING_FOR_COORDINATE_FRAMES_OF_REFERENCE_AT_RUN_TIME"></span>Berücksichtigung der-Koordinate Bezugsrahmen zur Laufzeit

[**"UIElement"** ](https://msdn.microsoft.com/library/windows/apps/BR208911) verfügt über eine Methode mit dem Namen [ **TransformToVisual**](https://msdn.microsoft.com/library/windows/apps/xaml/windows.ui.xaml.uielement.transformtovisual.aspx), das Generieren einer [ **transformieren** ](https://msdn.microsoft.com/library/windows/apps/BR243006) korreliert die Koordinate Bezugsrahmen für zwei Elemente der Benutzeroberfläche. So können Sie Elemente mit dem standardmäßigen Referenz-Koordinatennetz der App vergleichen, wenn der Stamm der visuellen Struktur als erster Parameter übergeben wird. Dies kann hilfreich sein, wenn ein Eingabeereignis von einem anderen Element erfasst wurde, oder wenn Layoutverhalten ohne das Anfordern einer Layoutübergabe prognostiziert werden soll.
...
## <a name="span-iddescribingatransformmathematicallyspanspan-iddescribingatransformmathematicallyspanspan-iddescribingatransformmathematicallyspandescribing-a-transform-mathematically"></a><span id="Describing_a_transform_mathematically"></span><span id="describing_a_transform_mathematically"></span><span id="DESCRIBING_A_TRANSFORM_MATHEMATICALLY"></span>Eine Transformation beschreibt mathematisch
...
* [3-d-Perspektiveneffekte für XAML-UI](3-d-perspective-effects.md)
* [**Transformieren**](https://msdn.microsoft.com/library/windows/apps/BR243006)
