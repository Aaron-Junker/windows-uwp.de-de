...
| --- | --- |
| [**RadialController** class](https://docs.microsoft.com/uwp/api/Windows.UI.Input.RadialController) and related | Stellt einen Radeingabegerät oder -Zubehör, z. B. das Surface Dial, dar. |
