...
> **Wichtige APIs:** ["CanDrag"-Eigenschaft](https://docs.microsoft.com/uwp/api/windows.ui.xaml.uielement.candrag), ["AllowDrop"-Eigenschaft](https://docs.microsoft.com/uwp/api/windows.ui.xaml.uielement.allowdrop) 
