...
Informationen zu den ersten Schritten finden Sie in der [Übersicht über das Cortana Skills Kit](https://docs.microsoft.com/cortana/skills/overview).

Weitere Informationen zum Erweitern von Cortana mit Funktionalität aus einer Windows-App mithilfe von Sprachbefehlen finden Sie unter [Cortana Voice-Befehle](https://docs.microsoft.com/cortana/voice-commands/vcd). 
