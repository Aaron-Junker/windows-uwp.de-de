...
> Wenn Sie nicht schon Visual Studio 2017 besitzen, sind mehrere Versionen erhältlich, einschließlich einer kostenlosen Version (Visual Studio 2017 Community Edition), und die anderen Versionen bieten kostenlose Testversionen an. Diese können Sie hier herunterladen: [https://developer.microsoft.com/windows/downloads](https://developer.microsoft.com/windows/downloads)
