...
-   [**AutoReverse**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.animation.timeline.autoreverse): Nachdem der letzte Keyframe erreicht wurde, werden die Frames in umgekehrter Reihenfolge vom Ende wiederholt. So wird die scheinbare Dauer der Animation verdoppelt.
...
-   [**FillBehavior**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.animation.timeline.fillbehavior): steuert, was geschieht, wenn der letzte Keyframe erreicht wird. **FillBehavior** hat keine Auswirkungen auf Zwischenkeyframes.
...
-   [**BackEase**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Media.Animation.BackEase): Zieht die Bewegung einer Animation etwas zurück, bevor die Animation im aufgeführten Pfad begonnen wird.
-   [**Bounceeasy**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Media.Animation.BounceEase): Erstellt einen Sprung-Effekt.
-   [**Zircleease**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Media.Animation.CircleEase): Erstellt eine Animation, die mit einer zirkulären Funktion beschleunigt oder verlangsamt.
-   [**Cubistop**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Media.Animation.CubicEase): Erstellt eine Animation, die mit der Formel f (t) = T3 beschleunigt oder verlangsamt wird.
-   [**Elastistop**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Media.Animation.ElasticEase): Erstellt eine Animation, die einer springenden Bewegung ähnelt, bis Sie in den Ruhezustand versetzt wird.
-   [**ExponentialEase**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Media.Animation.ExponentialEase): Erstellt eine Animation, die mit einer Exponentialformel beschleunigt oder verlangsamt.
-   [**Powereasy**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Media.Animation.PowerEase): Erstellt eine Animation, die mit der Formel f (t) = TP beschleunigt oder verlangsamt, wobei p gleich der Eigenschaft [**Power**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.animation.powerease.power) ist.
-   [**Quadraties beenden**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Media.Animation.QuadraticEase): Erstellt eine Animation, die mit der Formel f (t) = t2 beschleunigt oder verlangsamt wird.
-   [**Quartistop**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Media.Animation.QuarticEase): Erstellt eine Animation, die mit der Formel f (t) = t4 beschleunigt oder verlangsamt wird.
-   [**Quinitistop**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Media.Animation.QuinticEase): Erstellen Sie eine Animation, die mit der Formel f (t) = T5 beschleunigt oder verlangsamt wird.
-   [**SineEase**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Media.Animation.SineEase): Erstellt eine Animation, die mit einer Sinus Formel beschleunigt oder verlangsamt.
