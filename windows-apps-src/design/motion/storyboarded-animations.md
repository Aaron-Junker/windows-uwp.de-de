...
- Animieren des [**X**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.translatetransform.x) -Werts einer [**TranslateTransform**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Media.TranslateTransform), wie auf eine [**RenderTransform**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.uielement.rendertransform)angewendet: `(UIElement.RenderTransform).(TranslateTransform.X)`
...
- Animieren des [**X**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.translatetransform.x) -Werts eines [**TranslateTransform**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Media.TranslateTransform)-Werts, der 1 von 4 Transformationen in einer [**TransformGroup**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Media.TransformGroup)ist, wie auf eine [**RenderTransform**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.uielement.rendertransform)angewendet:`(UIElement.RenderTransform).(TransformGroup.Children)[3].(TranslateTransform.X)`
...
-   [**Double**](https://docs.microsoft.com/dotnet/api/system.double) kann mit jeder beliebigen [**DoubleAnimation**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Media.Animation.DoubleAnimation) animiert werden.
-   [**Point**](https://docs.microsoft.com/uwp/api/Windows.Foundation.Point) kann mit jeder [**PointAnimation**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Media.Animation.PointAnimation) animiert werden.
-   [**Color**](https://docs.microsoft.com/uwp/api/Windows.UI.Color) kann mit jeder [**ColorAnimation**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Media.Animation.ColorAnimation) animiert werden.
...
Wenn Sie [**Begin**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.animation.storyboard.begin) in einem Storyboard aufzurufen, das eine Animation enthält, die unendlich oft wiederholt `RepeatBehavior="Forever"` wird (), wird diese Animation so lange ausgeführt, bis die [**Pause**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.animation.storyboard.pause) Seite, [**Stop**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.animation.storyboard.stop)die Sie enthält, entladen wird.
...
Der Ereignishandler startet das [**Storyboard**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Media.Animation.Storyboard) (die Animation) mithilfe der [**Begin**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.animation.storyboard.begin) -Methode des **Storyboards**.
...
* [PropertyPath-Syntax](https://docs.microsoft.com/windows/uwp/xaml-platform/property-path-syntax)
...
* [Storyboardanimationen für visuelle Zustände](https://docs.microsoft.com/previous-versions/windows/apps/jj819808(v=win.10))
