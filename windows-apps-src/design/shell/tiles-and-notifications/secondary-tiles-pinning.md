...
> [!IMPORTANT]
> Wenn Sie eine Desktop Anwendung mit der Desktop Bridge sind, müssen Sie zunächst einen zusätzlichen Schritt ausführen, wie unter [Pin aus Desktop-Apps](secondary-tiles-desktop-pinning.md) beschrieben.
