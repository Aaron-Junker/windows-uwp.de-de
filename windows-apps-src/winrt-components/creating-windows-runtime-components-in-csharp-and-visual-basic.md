...
Intern können die Windows-Runtime-Typen in Ihrer Komponente alle .NET Framework-Funktionalitäten verwenden, die in einer UWP-app zulässig ist. Weitere Informationen finden Sie unter [.NET für UWP-apps](https://msdn.microsoft.com/library/windows/apps/mt185501).
