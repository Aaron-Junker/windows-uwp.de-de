...
| Thema | Beschreibung |
|-------|-------------|
| [Windows-Runtime-Komponenten mit C++/WinRT](./create-a-windows-runtime-component-in-cppwinrt.md) | In diesem Thema wird beschrieben, wie Sie eine Windows-Runtime-Komponente mit C++/WinRT erstellen und nutzen – eine Komponente, die aus einer universellen Windows-App aufgerufen werden kann, die in einer der Windows-Runtime-Sprachen erstellt wurde. |
