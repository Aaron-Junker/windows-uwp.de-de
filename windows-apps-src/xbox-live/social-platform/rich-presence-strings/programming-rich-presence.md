---
title: Programmierung umfassender vorhanden
description: Enthält ein Codebeispiel zum Festlegen von des Onlineanwesenheitsstatus eines Xbox Live-Members.
...
ms.locfileid: "57648525"
---
# <a name="programming-rich-presence"></a>Programmierung umfassender vorhanden

Rich-Anwesenheit bietet Funktionen für die Ankündigung von der aktuellen Aktivität Weitere Entwicklungen des Spielers. Weitere Informationen finden Sie unter [umfassender vorhanden Zeichenfolgen: Übersicht über die](rich-presence-strings-overview.md).
