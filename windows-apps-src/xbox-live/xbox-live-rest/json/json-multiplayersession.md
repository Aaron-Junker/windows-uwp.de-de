...
Das MultiplayerSession JSON-Objekt hat den folgenden Spezifikationen.
...
Die Anforderung-Struktur, das dieser JSON-Spezifikation zugeordnet ist, finden Sie [MultiplayerSessionRequest (JSON)](json-multiplayersessionrequest.md).  
<a id="ID4EPB"></a>
