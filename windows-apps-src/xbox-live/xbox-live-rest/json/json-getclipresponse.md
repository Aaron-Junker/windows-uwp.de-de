...
GetClipResponse Objekt verfügt über den folgenden Spezifikationen.
 
| Mitglied| Typ| Beschreibung| 
| --- | --- | --- | 
| gameClip| [GameClip](json-gameclip.md)| Ein einzelner Clip Spiele, der die Abfrage erfüllt.| 
