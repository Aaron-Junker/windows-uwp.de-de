...
Lädt eine Datei herunter. Die Domäne für diese URIs ist `titlestorage.xboxlive.com`.
  ...
  * [Erforderlichen Anforderungsheader](#ID4EZC)
  * [Optionale Anforderungsheader](#ID4ECE)
  * [Anforderungstext](#ID4EMF)
  * [HTTP-Statuscodes](#ID4EZF)
  * [Antwortheader](#ID4EMDAC)
  * [Antworttext](#ID4EPEAC)
...
| customSelector| string| Für Typ-Konfigurationsdateien. Gibt an, welche benutzerdefinierte virtuelle Knoten enthalten. Weitere Informationen zum Typ von Konfigurationsdateien finden Sie unter Title-Speicher.| 
