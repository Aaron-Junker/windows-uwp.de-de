...
## [URIs für Gameserver](uri/gsdk/atoc-gsdk-uri-reference.md)
...
## [URIs für Spielersuche](uri/matchtickets/atoc-reference-matchtickets.md)
...
## [URIs für Sitzungsverzeichnis](uri/sessiondirectory/atoc-reference-sessiondirectory.md)
...
## [URIs für Validierung von Systemzeichenfolgen](uri/stringserver/atoc-reference-systemstringsvalidate.md)
...
## [URIs für Benutzerstatistiken](uri/userstats/atoc-reference-userstats.md)
...
# [JSON-Objektverweis (JavaScript Object Notation)](json/atoc-xboxlivews-reference-json.md)
...
# [Weiterer Verweis](additional/atoc-xboxlivews-reference-additional.md)
...
## [Standard-HTTP-Anforderungs- und -Antwortheader](additional/httpstandardheaders.md)
