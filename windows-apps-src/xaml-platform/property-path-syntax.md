...
1.  Das Datenkontextobjekt (oder eine mit derselben [**Binding**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.data.binding.source)-Klasse angegebene [**Source**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Data.Binding)-Eigenschaft) wird nach einer Eigenschaft namens „Customer“ durchsucht.
