...
**Beachten** Sie, dass   XAML-Designer häufig Sortier Konventionen herauf Stufen, wenn Sie andere Entwurfs Oberflächen als den XML-Editor verwenden, aber Sie können diese XAML-Datei später kostenlos bearbeiten, um die Attribute neu anzuordnen oder neue Attribute einzuführen.
...
**Hinweis**    "\\}" funktioniert auch, wenn Sie in einem Attribut in Anführungszeichen eingeschlossen ist.
 
...
**Hinweis**   In Referenz Themen für APIs, die XAML verwenden, und Verwenden von Enumerationen, klicken Sie auf den Link zum Enumerationstyp im Abschnitt mit den **Eigenschafts Werten** der **Syntax**. So gelangen Sie auf die Enumerationsseite, auf der Sie die benannten Konstanten für diese Enumeration ermitteln können.
