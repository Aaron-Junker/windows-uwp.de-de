...
* [Tastaturinteraktionen](https://docs.microsoft.com/windows/uwp/input-and-devices/keyboard-interactions)
* [.NET-Ereignisse und -Delegate](https://msdn.microsoft.com/library/17sde2xt.aspx)
