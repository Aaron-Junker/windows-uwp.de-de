...
<thead>
<tr class="header">
<th align="left"><strong>Allgemeine Konzept</strong></th>
...
<td align="left"><strong>Entwerfen Sie die Sprache.</strong><br><br>Eine Reihe von Konventionen für das Aussehen und Verhalten von Apps auf der Plattform.</td>
...
<td align="left"><a href="https://developer.microsoft.com/en-us/windows/apps/design"><strong>UWP-Windows-App-Entwurfs</strong> </a> erfahren Sie, wie Sie eine app erstellen, die auf allen Windows 10-Geräten großartig aussieht. Dort finden Sie Grundlagen zum Benutzeroberflächenentwurf, Techniken für reaktionsfähiges Design und eine umfassende Liste ausführlicher Richtlinien.<br/></td>
</tr>
<tr class="even">
<td align="left"><strong>Markupsprache der Benutzeroberfläche.</strong> <br><br>Eine Markupsprache, mit der die Benutzeroberfläche und ihre Komponenten gerendert und beschrieben werden. Jede Plattform bietet einen Editor für die visuelle Bearbeitung und Markupbearbeitung.<br/></td>
...
<tr class="even">
<td align="left"><strong>Zur Verarbeitung von Ereignissen zu steuern.</strong> <br><br>Definieren der Logik, die ausgeführt wird, wenn in UI-Steuerelementen Ereignisse ausgelöst werden.</td>
...
<tr class="odd" style="background-color: #f2f2f2">
<td align="left"><strong>Die Datenbindung.</strong> <br><br>Ein Softwaredesignmuster, das der App-UI das Rendern von Daten und optional das Synchronisieren mit diesen Daten ermöglicht.</td>
...
<td align="left">Die <strong><a href="https://msdn.microsoft.com/library/windows/apps/ee684076.aspx">Benutzeroberflächenautomatisierung</a></strong> bietet Ihnen unmittelbaren programmgesteuerten Zugriff auf integrierte UI-Elemente in UWP.<br/><strong><a href="https://msdn.microsoft.com/library/windows/apps/mt297667.aspx">Benutzerdefinierte Automatisierungspeers</a></strong>  ermöglichen es Ihnen, eigene benutzerdefinierten UI-Klassen-Unterstützung bereit. Das <strong><a href="https://msdn.microsoft.com/library/dd286726.aspx#VerifyingCodeUsingCUITCreate">Projekt mit Tests der codierten UI</a></strong> in Visual Studio ermöglicht Ihnen das Durchführen automatisierter Tests der gesamte Anwendung über die UI oder das Testen der isolierten UI.</td>
</tr>
<tr class="odd" style="background-color: #f2f2f2">
<td align="left"><strong>Ändern der Darstellung eines Steuerelements an.</strong> <br><br>Bearbeiten von Größe, Farbe und anderen Attributen.</td>
...
<tr class="even">
<td align="left"><strong>Wiederverwendbare visuellen Stilen.</strong> <br><br>Anwenden visueller Änderungen in einem wiederverwendbaren Format auf eine Reihe von Steuerelementen.</td>
...
<td align="left">Sie können wiederverwendbare <strong><a href="https://msdn.microsoft.com/library/windows/apps/xaml/windows.ui.xaml.style.aspx">Stile</a></strong> erstellen, die auf mehrere Steuerelemente angewendet und für die einfache Wiederverwendung in einem <strong><a href="https://msdn.microsoft.com/library/windows/apps/xaml/windows.ui.xaml.resourcedictionary.aspx">ResourceDictionary</a></strong> gespeichert werden.<br/><br/><a href="https://msdn.microsoft.com/library/windows/apps/xaml/hh465381.aspx">Schnellstart: Formatieren von Steuerelementen</a></td>
</tr>
<tr class="odd" style="background-color: #f2f2f2">
<td align="left"><strong>Bearbeiten die visuelle Struktur von Steuerelementen an.</strong> <br><br>Sie können die visuelle Struktur eines Steuerelements umfassender anpassen, als lediglich Eigenschaften oder Attribute zu ändern, z. B. den Kontrollkästchentext unter das Kontrollkästchen verschieben.</td>
...
<td align="left"><strong><a href="https://msdn.microsoft.com/library/windows/apps/dn449149.aspx">Hubs</a></strong>  können Sie dem Benutzer eine Vorschau der Inhalt, der ausgewählt werden kann, navigieren zu untergeordneten Seiten anzeigen. <strong><a href="https://msdn.microsoft.com/library/windows/apps/dn997765.aspx">Master-/Detail-</a></strong>  können Benutzer, die aus einer Liste von Zusammenfassungen von Element auswählen, die neben der entsprechenden Detailabschnitt angezeigt werden soll.<br/><br/><a href="https://msdn.microsoft.com/windows/uwp/layout/navigation-basics">Navigation</a><br/><br/><a href="https://msdn.microsoft.com/windows/uwp/layout/navigate-between-two-pages">Navigieren Sie zwischen zwei Seiten</a></td>
</tr>
<tr class="even">
<td align="left"><strong>Sichern Sie Menüschaltflächen zur Navigation.</strong> <br><br>Rückwärtsnavigation in einer Anwendung.</td>
...
<td align="left">Mit der <strong><a href="https://msdn.microsoft.com/library/windows/apps/windows.ui.xaml.controls.frame.backstack.aspx">BackStack-Eigenschaft</a></strong>, die dem Benutzer das Durchlaufen des <strong>Navigationsverlaufs</strong> ermöglicht, lässt sich das Betätigen der Zurück-Schaltfläche bzw. Zurück-Taste einfach behandeln.<br/><br/><a href="https://msdn.microsoft.com/library/windows/apps/mt465734.aspx">Navigation per Schaltfläche „Zurück“</a></td>
</tr>
<tr class="odd" style="background-color: #f2f2f2">
...
<tbody>
<tr class="odd" style="background-color: #f2f2f2">
<td align="left"><strong>Stimme.</strong> <br><br>Spracherkennung für die Spracheingabe und zusätzliche Sprachfunktionen.</td>
...
<tr class="even">
<td align="left"><strong>Benutzerdefinierte Eingaben.</strong> <br><br>Behandeln von Eingaben per Tastatur, Maus, Stift und anderen Eingaben.</td>
...
<td align="left">Sie können Daten mithilfe <strong>SQLite</strong> speichern. <strong><a href="https://msdn.microsoft.com/library/windows/apps/xaml/mt592863.aspx">Entitätsframework</a></strong>  ist eine integrierte ORM entfällt die Notwendigkeit, die viele Datenzugriffscode zu schreiben und ermöglicht es Ihnen, einfach die Datenbank abzufragen, ohne das Schreiben von SQL. Sie können SQL-Abfragen direkt mit der <a href="https://msdn.microsoft.com/library/windows/apps/xaml/mt592864.aspx">SQLite-Bibliothek</a> ausführen.<br/><br/><a href="https://msdn.microsoft.com/library/windows/apps/xaml/mt592862.aspx">Datenzugriff</a></td>
</tr>
<tr class="odd" style="background-color: #f2f2f2">
<td align="left"><strong>HTTP-Clientbibliotheken für REST-Zugriff.</strong> <br><br>Integrierte Bibliotheken, die Ihnen die Kommunikation mit Webdiensten und Webservern per HTTP(S) ermöglichen.<br/></td>
...
<tr class="even">
<td align="left"><strong>Cloud-backup-Diensts.</strong> <br><br>Von der Plattform bereitgestellte Sicherungsdienste für App-Daten.</td>
...
<tr class="odd" style="background-color: #f2f2f2">
<td align="left"><strong>HTTP-Datei wird heruntergeladen.</strong> <br><br>Herunterladen von kleinen und großen Dateien per HTTP.</td>
...
<td align="left">Mit der <strong><a href="https://msdn.microsoft.com/library/windows/apps/windows.networking.backgroundtransfer.aspx">Hintergrundübertragungs-API</a></strong> können Sie Dateien zuverlässig per HTTP(S) und FTP übertragen und dabei das Anhalten der App sowie Verbindungsunterbrechungen berücksichtigen und Anpassungen entsprechend Konnektivität und Akkulaufzeit vornehmen. Sie können auch die <strong><a href="https://msdn.microsoft.com/library/windows/apps/windows.web.http.httpclient.aspx">HttpClient</a></strong>-Klasse verwenden, die sich besonders für kleinere Dateien eignet.<br/><br/><a href="https://msdn.microsoft.com/library/windows/apps/mt280235.aspx">Welche Netzwerktechnologie?</a><br/><br/><a href="https://msdn.microsoft.com/library/windows/apps/mt280377.aspx">Hintergrundübertragungen</a></td>
</tr>
<tr class="even">
...
<td align="left"><strong><a href="https://www.visualstudio.com/features/universal-windows-platform-vs.aspx">Visual Studio</a></strong>  und <strong><a href="https://msdn.microsoft.com/library/jj171012.aspx">Blend für Visual Studio</a></strong> verfügt über alle Tools, die Sie benötigen das Programmieren, entwerfen, eine Verbindung herstellen, Debuggen, zu analysieren, optimieren und Testen von UWP-apps. Visual Studio bietet Ihnen außerdem <strong><a href="https://msdn.microsoft.com/library/windows/apps/mt188754.aspx">Emulatoren</a></strong> für Windows 10-Geräte, sodass Sie Ihre App auf unterschiedlichen emulierten Geräten testen können.<br/><br/><a href="https://dev.windows.com/downloads">Downloads und Tools für UWP</a></td>
</tr>
<tr class="even">
<td align="left"><strong>Organisation von Code.</strong> <br><br>Die grundlegende Ordnerstruktur einer App, häufig anhand einer anfänglichen Vorlage erstellt.</td>
...
<td align="left">Jede Aktivität verfügt über einen eigenen <strong>Aktivitätslebenszyklus</strong> mit Zuständen, z. B. <strong>resumed</strong>. <strong>Lebenszyklus von Rückrufen</strong> wie z. B. <strong>OnResume</strong> werden implementiert, Ihre <strong>Aktivitätsklassen</strong>.</td>
...
<tr class="even">
<td align="left"><strong>Aufgaben im Hintergrund.</strong> <br><br>Aufgaben, die Vorgänge im Hintergrund ausführen und weiterhin ausgeführt werden, wenn die App nicht mehr im Vordergrund ausgeführt wird.</td>
...
<tbody>
<tr class="odd" style="background-color: #f2f2f2">
<td align="left"><strong>Bewährte Methoden für Leistung.</strong> <br><br>Richtlinien für das Erstellen von schnellen, dynamischen und akkuschonenden Apps mit kurzer Startzeit.</td>
...
<tr class="odd" style="background-color: #f2f2f2">
<td align="left"><strong>Optimierung für Liste anzeigen.</strong> <br><br>Integrierte Muster zum Optimieren von Datenlisten, die häufig eine geringe Leistung aufweisen, wenn große Mengen von Daten angezeigt werden müssen.</td>
...
<td align="left">Sie erstellen In-App-Produktkäufe für Ihre App, indem Sie <a href="https://msdn.microsoft.com/library/windows/apps/mt148551.aspx">sie Ihrer App hinzufügen und an den Store übermitteln</a>. <br/><br/>Sie definieren In-App-Käufe mit der <strong><a href="https://msdn.microsoft.com/library/windows/apps/windows.applicationmodel.store.currentapp.aspx">CurrentApp-Klasse</a></strong>. <br/><br/>Mit <strong><a href="https://msdn.microsoft.com/library/windows/apps/windows.applicationmodel.store.currentapp.requestproductpurchaseasync.aspx">CurrentApp.RequestProductPurchaseAsync</a></strong> zeigen Sie die Benutzeroberfläche an, auf der Kunden das Produkt kaufen können.<br/><br/><a href="https://msdn.microsoft.com/library/windows/apps/mt219684.aspx">Aktivieren von In-App-Produktkäufen</a></td>
</tr>
<tr class="even">
<td align="left"><strong>In-app-Einkäufe genutzt werden.</strong> <br><br>In-App-Produkte, die gekauft, verwendet und dann erneut gekauft werden können.</td>
...
<tr class="odd" style="background-color: #f2f2f2">
<td align="left"><strong>Testen von in-app-Käufe.</strong> <br><br>Ermöglichen es Ihnen, den Code für In-App-Käufe zu testen, ohne Ihre App an den Store zu übermitteln.</td>
...
<tr class="odd" style="background-color: #f2f2f2">
<td align="left"><strong>Adaptive Benutzeroberfläche: reaktionsfähig Layouts.</strong> <br><br>Reaktion auf Änderungen der Bildschirmgröße, z. B. Drehung, oder eine Änderung der Fenstergröße.</td>
...
<tr class="even">
<td align="left"><strong>Unterstützung von Funktionen für die verschiedenen Geräte.</strong> <br><br>Nutzen Sie erweiterte Hardwarefeatures, während Geräte, die diese nicht aufweisen, trotzdem unterstützt werden.</td>
...
<tr class="odd" style="background-color: #f2f2f2">
<td align="left"><strong>Lokale Benachrichtigungen wird geplant.</strong> <br><br>Lokale Benachrichtigungen, die von der App zu einem geplanten Zeitpunkt gesendet werden.</td>
...
<td align="left">Lokale Benachrichtigungen werden mithilfe von erstellt <strong>UILocalNotification</strong>, und kann geplant werden, für die <b> UILocalNotification.scheduleLocalNotification:<strong>. | Sie können planen, eine Toast-Benachrichtigung mit</strong>  <a href="https://msdn.microsoft.com/library/windows/apps/xaml/windows.ui.notifications.scheduledtoastnotification.aspx">"scheduledtoastnotification"</a><strong>. Sie können mit der</strong> <a href="https://msdn.microsoft.com/library/windows/apps/xaml/windows.ui.notifications.tilenotification.aspx">TileNotification-Klasse</a><strong> eine Kachelbenachrichtigung von der App senden oder mit <a href="https://msdn.microsoft.com/library/windows/apps/xaml/windows.ui.notifications.scheduledtilenotification.aspx">ScheduledTileNotification</a> eine Kachelbenachrichtigung planen.<br/><br/><a href="https://msdn.microsoft.com/library/windows/apps/xaml/mt631604.aspx">Adaptive und interaktive Popupbenachrichtigungen</a><br/><br/><a href="https://msdn.microsoft.com/library/windows/apps/xaml/mt593299.aspx">Senden Sie eine lokale Tile-Benachrichtigung</a> || </strong>Senden von Pushbenachrichtigungen.</b> Von einem Pushbenachrichtigungsserver wird eine Benachrichtigung gesendet, die optional in der App behandelt wird.</td>
...
<tbody>
<tr class="odd" style="background-color: #f2f2f2">
<td align="left"><strong>Erfassen von Medien.</strong> <br><br>Aufzeichnen von Audio- und visuellen Inhalten.</td>
...
<tr class="odd" style="background-color: #f2f2f2">
<td align="left"><strong>Bearbeiten die Medien.</strong> <br><br>Erstellen neuer Mediendateien aus vorhandenen Aufzeichnungen und Anwenden von Spezialeffekten.</td>
...
<td align="left">Die <strong>zentralen Standort</strong> <strong>CLLocationManager</strong> Klasse wird verwendet, um den Standort eines Geräts, mit Überwachen <strong>StartUpdatingLocation</strong> für den standardmäßigen Speicherort-Dienst und die <strong>StartMonitoringSignificantLocationChanges</strong> für die <strong>signifikante Änderung</strong> ortsdienst.</td>
...
<tr class="even">
<td align="left"><strong>Geocodierung und reverse-Geocoding.</strong> <br><br>Das Umwandeln von Adressen in geografische Standorte (Geocodierung) und das Umwandeln geografischer Standorte in Adressen (umgekehrte Geocodierung).<br/></td>
...
<tbody>
<tr class="odd" style="background-color: #f2f2f2">
<td align="left"><strong>Das Aufrufen einer anderen app.</strong> <br><br>Starten einer anderen App und optionales Freigeben von Daten, z. B. Links, Text, Fotos, Videos und Dateien.</td>
...
<tr class="even">
<td align="left"><strong>Ermöglichen Ihrer app aufgerufen werden.</strong> <br><br>Zulassen, dass Ihre App auf eine Anforderung von einer anderen App antwortet.</td>
...
<td align="left">Viele Standard-XAML-Steuerelemente unterstützen bereits Kopieren und Einfügen. Sie können mithilfe der <strong><a href="https://msdn.microsoft.com/library/windows/apps/windows.applicationmodel.datatransfer.datapackage.aspx">DataPackage</a></strong>-Klasse und der <strong><a href="https://msdn.microsoft.com/library/windows/apps/xaml/windows.applicationmodel.datatransfer.clipboard.aspx">Clipboard</a></strong>-Klasse in <strong><a href="https://msdn.microsoft.com/library/windows/apps/br205967">Windows.ApplicationModel.DataTransfer</a></strong> Kopieren und Einfügen selbst implementieren.<br/><br/><a href="https://msdn.microsoft.com/library/windows/apps/xaml/mt243291.aspx">Kopieren und Einfügen</a></td>
</tr>
<tr class="even">
...
<td align="left">Sie können in der App Drag & Drop implementieren, um Drag & Drop-Funktionen von App zu App, von Desktop zu App und von App zu Desktop zu ermöglichen. Sie können in der UIElement-Klasse mit der <strong><a href="https://msdn.microsoft.com/library/windows/apps/xaml/windows.ui.xaml.uielement.allowdrop.aspx">AllowDrop</a></strong>-Eigenschaft und der <strong><a href="https://msdn.microsoft.com/library/windows/apps/xaml/windows.ui.xaml.uielement.candrag.aspx">CanDrag</a></strong>-Eigenschaft sowie mit dem <strong><a href="https://msdn.microsoft.com/library/windows/apps/xaml/windows.ui.xaml.uielement.dragover.aspx">DragOver</a></strong>-Ereignis und dem <strong><a href="https://msdn.microsoft.com/library/windows/apps/xaml/windows.ui.xaml.uielement.drop.aspx">Drop</a></strong>-Ereignis Unterstützung für Drag & Drop implementieren.<br/><br/><a href="https://msdn.microsoft.com/library/windows/apps/xaml/mt227651.aspx">Drag & Drop</a></td>
</tr>
</tbody>
</table>
...
<tbody>
<tr class="odd" style="background-color: #f2f2f2">
<td align="left"><strong>Entwurfsmuster für die Software.</strong> <br><br>Empfohlene oder perfekt verwendete Muster für die Plattform.</td>
