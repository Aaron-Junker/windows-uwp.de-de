...
| XAML-UI | Windows 10, Version 1809 und früheren Versionen nicht hosting UWP XAML-Inhalt in desktop-apps App-Pakete unterstützt. Ab Windows 10, Version 1903 sein, können Sie [XAML-Inseln](../xaml-platform/xaml-host-controls.md) Host UWP XAML-Inhalt.  |
...
Im folgenden finden Sie eine vollständige Liste der UWP-APIs, die in verpackten Apps unterstützt werden. Sie können anzeigen, [APIs, die nur in App-Pakete unterstützt](#new) oder [APIs, die in App-Pakete und desktop-Anwendungen unterstützt](#both).
