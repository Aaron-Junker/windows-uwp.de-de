...
-   [Erstellen einer "Hello, World!"-App mit C++/WinRT](/windows/uwp/get-started/create-a-basic-windows-10-app-in-cppwinrt)
-   [Erstellen einer "Hello, World!"-App mit C++/CX](/windows/uwp/get-started/create-a-basic-windows-10-app-in-cpp)
...
-   [Beispiele für UWP-apps, die DirectX verwenden](https://docs.microsoft.com/samples/browse/?expanded=windows&products=windows-uwp&terms=directx)
-   [Wo finde ich das DirectX SDK?](https://docs.microsoft.com/windows/desktop/directx-sdk--august-2009-)
...
-   [UWP-App-Beispiele mit C #](https://docs.microsoft.com/samples/browse/?expanded=windows&products=windows-uwp&languages=csharp)
