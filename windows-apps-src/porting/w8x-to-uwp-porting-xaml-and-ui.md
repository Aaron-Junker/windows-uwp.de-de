...
| [**Textfeld**](/uwp/api/Windows.UI.Xaml.Controls.TextBox) | In einer Windows-Runtime 8. x-APP ist die Rechtschreibprüfung für ein [**Textfeld**](/uwp/api/Windows.UI.Xaml.Controls.TextBox)standardmäßig deaktiviert. In einer Windows Phone Store-App und einer Windows 10-App ist sie standardmäßig aktiviert. |
| [**Textfeld**](/uwp/api/Windows.UI.Xaml.Controls.TextBox) | Die Standardschriftgröße für ein [**TextBox**](/uwp/api/Windows.UI.Xaml.Controls.TextBox)-Element hat sich von 11 in 15 geändert. |
| [**Textfeld**](/uwp/api/Windows.UI.Xaml.Controls.TextBox) | Der Standardwert von [**TextBox.TextReadingOrder**](/uwp/api/windows.ui.xaml.controls.textblock.textreadingorder) wurde von **Default** in **DetectFromContent** geändert. Falls Sie dies nicht wünschen, können Sie **UseFlowDirection** verwenden. **Default** ist veraltet. |
...
Weitere Informationen zu Steuerelementen für UWP-Apps finden Sie unter [Steuerelemente nach Funktion](../design/controls-and-patterns/index.md), [Liste der Steuerelemente](../design/controls-and-patterns/index.md) und [Richtlinien für Steuerelemente](../design/controls-and-patterns/index.md).
