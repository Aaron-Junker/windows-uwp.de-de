...
title: Integrieren Ihrer App in Windows 10 (Desktop-Brücke)
ms.date: 04/18/2018
ms.topic: article
...
ms.locfileid: "57613825"
---
# <a name="integrate-your-packaged-desktop-application-with-windows-10"></a>Integrieren Sie Ihre App-Pakete Desktopanwendung mit Windows 10

Verwenden Sie Erweiterungen, um die App-Pakete desktop-Anwendung mit Windows 10 auf vordefinierte Weise zu integrieren.
...
|Name |Eine eindeutige ID für Ihre App. |
|FileType |Die relevanten Dateierweiterungen. |
|value |Ein gültiger [Art-Wert](https://msdn.microsoft.com/en-us/library/windows/desktop/cc144136.aspx#kind_hierarchy) |
