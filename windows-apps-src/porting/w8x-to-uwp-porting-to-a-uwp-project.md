...
Klicken Sie auf **Projekt** , &gt; Verweis &gt; **Windows Universal** &gt; **Extensions** **hinzuzufügen** und das entsprechende Erweiterungs-SDK auszuwählen. Wenn die gewünschten APIs also beispielsweise nur in der Familie für mobile Geräte verfügbar sind und in Version 10.0.x.y eingeführt wurden, wählen Sie **Windows Mobile-Erweiterungen für die UWP** aus.
