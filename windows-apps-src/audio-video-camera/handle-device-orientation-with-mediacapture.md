...
Schließlich wird der Eigenschaftensatz, der die Ausrichtungsdaten enthält, für den Encoder mit einem Aufruf von [**SetPropertiesAsync**](https://developer.microsoft.com/windows/apps/develop) festgelegt, und das Bild wird mit einem Aufruf von [**FlushAsync**](https://docs.microsoft.com/uwp/api/windows.graphics.imaging.bitmapencoder.flushasync) transcodiert.
