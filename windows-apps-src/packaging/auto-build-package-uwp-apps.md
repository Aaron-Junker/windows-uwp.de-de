...
Informationen zum Anzeigen aller vordefinierten Variablen finden Sie unter [vordefinierte Buildvariablen](https://docs.microsoft.com/azure/devops/pipelines/build/variables).
