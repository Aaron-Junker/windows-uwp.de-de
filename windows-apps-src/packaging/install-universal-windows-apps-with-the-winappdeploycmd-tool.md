...
Das Tool **WinAppDeployCmd.exe** befindet sich auf Ihrem Windows 10-Computer unter folgendem Pfad: **C:\\Programme (x86)\\Windows Kits\\10\\bin\\&lt;SDK Version&gt;\\x86\\WinAppDeployCmd.exe** (abhängig vom Installationspfad für das SDK).
