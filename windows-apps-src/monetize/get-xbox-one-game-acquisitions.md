...
|---------------|--------|---------------|------|
| applicationId | String | Die Produkt-ID des Xbox One Spiels, für das Sie Kaufdaten abrufen. Beachten Sie, dass dies die Store-ID und nicht die XDP-Produkt-ID Navigieren Sie zu Ihr Spiel in der XDP Analytics-Anwendung, und rufen Sie die Productid aus der URL, rufen Sie die Produkt-ID Ihres Spiels. Wenn Sie die Übernahmen Daten aus den Partner Center-Analysebericht herunterladen, ist die Produkt-ID auch in das TSV-Datei enthalten.  |  Ja  |
