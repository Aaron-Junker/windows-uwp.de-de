...
| Blocks |  <ul><li>[Aktualisieren Sie upgradeblöcke für Ihre Desktop Anwendung.](get-desktop-block-data.md)</li><li>[Aktualisierungs Block Details für Ihre Desktop Anwendung](get-desktop-block-data-details.md)</li></ul> |
