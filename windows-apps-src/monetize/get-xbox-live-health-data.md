...
ms.locfileid: "57650905"
---
# <a name="get-xbox-live-health-data"></a>Abrufen von Xbox Live-Integritätsdaten


Verwenden Sie diese Methode in der Microsoft Store-Analyse-API, um Integritätsdaten für Ihr [Xbox Live-fähiges Spiel](../xbox-live/index.md) abzurufen. Diese Informationen sind auch verfügbar in der [Xbox-Analysebericht](../publish/xbox-analytics-report.md) im Partner Center.
