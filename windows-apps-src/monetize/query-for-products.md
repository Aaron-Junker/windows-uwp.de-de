...
| productTypes      | Liste&lt;Zeichenfolge&gt;       | Gibt an, welche Produkttypen in den Abfrage Ergebnissen zurückgegeben werden sollen. Unterstützte Produkttypen sind **Application**, **Durable** und **UnmanagedConsumable**.     | Ja       |
