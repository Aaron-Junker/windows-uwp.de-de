---
title: App-Analyse
description: Erfahren Sie mehr über das App-Analysetool, und sehen Sie sich die Leistungsrichtlinien und bewährten Methoden an, die zur Bewertung Ihres App-Codes verwendet werden.
ms.date: 02/08/2017
ms.topic: article
...
Wenn ein Bild für ein [**NineGrid**](/uwp/api/windows.ui.xaml.controls.image.ninegrid)-Element verwendet wird, wird für das Bild ein Softwarerasterungspfad genutzt, bei dem Bilder gar nicht skaliert werden. Zudem muss eine Kopie des Bilds sowohl im Arbeitsspeicher der Software als auch der Hardware gespeichert werden. Bei Verwendung von **NineGrid** sollte die App die Bilder vorab auf die ungefähre Größe skalieren, in der sie gerendert werden.
...
Eine vollständige Liste mit bewährten Methoden zur Verbesserung der Startleistung Ihrer App finden Sie unter [Bewährte Methoden für die Leistung Ihrer App beim Starten](./best-practices-for-your-app-s-startup-performance.md) und [Aufrechterhalten der Reaktionsfähigkeit des UI-Threads](./keep-the-ui-thread-responsive.md).
