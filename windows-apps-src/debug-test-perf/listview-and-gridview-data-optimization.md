...
[**Iitemsrangeinfo**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Data.IItemsRangeInfo) enthält Informationen darüber, welche Elemente das Steuerelement aktiv verwendet. Das Steuerelement ruft diese Methode bei jeder Änderung der Ansicht auf und bezieht diese beiden Sätze von Bereichen ein.
