...
#### <a name="clipboard"></a>[Zwischenablage](/uwp/api/windows.applicationmodel.datatransfer.clipboard)
...
#### <a name="control"></a>[Steuern](/uwp/api/windows.ui.xaml.controls.control)
