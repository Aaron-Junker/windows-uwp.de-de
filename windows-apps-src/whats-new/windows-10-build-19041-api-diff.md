...
#### <a name="accelerometer"></a>[Beschleunigungsmesser](/uwp/api/windows.devices.sensors.accelerometer)
...
#### <a name="language"></a>[Sprache](/uwp/api/windows.globalization.language)
