...
<table>
    ...
    <tr>
        ...
        <td><a href="https://docs.microsoft.com/windows/uwp/winrt-components/creating-windows-runtime-components-in-cpp">Windows-Runtime Komponenten mit C++/CX</a></td>
    </tr>
</table>
