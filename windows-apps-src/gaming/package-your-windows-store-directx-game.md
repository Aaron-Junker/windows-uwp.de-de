...
-   Objektdateien weisen den gleichen Dateinamen auf, und die einzelnen Ressourcenpaketversionen werden in Verzeichnisse mit bestimmten Namen eingefügt. Diese Verzeichnisnamen werden vom System reserviert. \\z. b. "en-US", "\\Scale-140 \\dxfl-DX11".
-   Objektdateien werden in Ordnern mit beliebigen Namen gespeichert. Die Dateien werden jedoch mit einer gemeinsamen Bezeichnung benannt, die mit Zeichenfolgen angehängt wird, die das System zum Angeben von Sprach- und anderen Qualifizierern reserviert. Insbesondere werden die Qualifiziererzeichenfolgen nach einem Unterstrich ("\_") dem generalisierten Dateinamen angehängt. Beispielsweise \\Assets\\Menü\_Option1\_lang-en-US. png, \\\\Menü\_\_\\\\\_dxfl-DX11. DDS. Sie können diese Zeichenfolgen auch kombinieren. Beispielsweise \\Assets\\Menü\_Option1\_Scale-140\_lang-en-US. png.
    > **Beachten Sie**   Wenn Sie in einem Dateinamen statt allein in einem Verzeichnisnamen verwendet werden, muss ein sprach Qualifizierer das Format "lang-<tag>" (z. b. "lang-en-US") annehmen, wie in [Anpassen Ihrer Ressourcen für Sprache, Skalierung und andere Qualifizierer](../app-resources/tailor-resources-lang-scale-contrast.md)beschrieben.

     

Verzeichnisnamen können beim Packen von Ressourcen kombiniert werden, um die Genauigkeit zu erhöhen. Sie dürfen jedoch nicht redundant sein. Beispielsweise ist \\en-US\\Menü\_Option1\_lang-en-US. png redundant.

Sie können unter einem Ressourcenverzeichnis einen benötigten nicht reservierten Namen eines Unterverzeichnisses angeben, solange die Verzeichnisstruktur in jedem Ressourcenverzeichnis identisch ist. Beispielsweise \\dxfl-DX10\\Assets\\Texturen\\coolsign. DDS. Wenn Sie eine Ressource laden oder darauf verweisen, muss der Pfadname generalisiert werden. Dabei müssen alle Qualifizierer für Sprache, Skalierung und DirectX-Featureebene unabhängig davon entfernt werden, ob sie sich in Ordnerknoten oder in den Dateinamen befinden. Um z. b. im Code auf ein Medienobjekt zu verweisen, für das eine der Varianten \\dxfl-DX10\\Assets\\Texturen\\coolsign. DDS ist, verwenden Sie \\Assets\\Texturen\\coolsign. DDS. Verwenden Sie zum Verweisen auf ein Medienobjekt mit einem Variant-\\Images\\Hintergrund\_Scale-140. png \\Bilder\\background. png.
...
| Ressourcen für Skalierungsfaktor        | scale-100, scale-140, scale-180. Gilt für die UI-Skalierungsfaktoren 1,0x, 1,4x bzw. 1,8x.                                     | Eine "\_", gefolgt von "Scale-100", "Scale-140" oder "Scale-180".                                                                    |
...
-   Achten Sie darauf, dass die Ressourcen- und Zeichenfolgendateien (.resw) in jedem Verzeichnis gleich benannt sind. Beispielsweise sollte das Menü\_Option1. png in den Verzeichnissen \\en-US und \\JP-JP denselben Namen haben, auch wenn der Inhalt der Datei für eine andere Sprache gilt. In diesem Fall werden Sie als \\en-US-\\Menü\_Option1. png und \\JP-JP\\Menü\_Option1. png angezeigt.
    > **Beachten** Sie   Sie optional das Gebiets Schema an den Dateinamen anfügen und im gleichen Verzeichnis speichern können. beispielsweise \\Assets\\Menü\_Option1\_lang-en-US. png, \\\\Menü\_\_lang-JP-JP. png.
...
-   Achten Sie darauf, dass die Ressourcen in jedem Verzeichnis gleich benannt sind. Beispielsweise sollte das Menü\_Option1. png in den Verzeichnissen \\Scale-100 und \\Scale-180 denselben Namen haben, auch wenn der Inhalt der Datei anders ist. In diesem Fall werden Sie als \\Menü "Skala-100\\"\_"Option1. png" und \\\\Menü "Scale-140\_" "Option1. png" angezeigt.
    > **Beachten** Sie   wieder, dass Sie das Skalierungsfaktor Suffix optional an den Dateinamen anfügen und im gleichen Verzeichnis speichern können. beispielsweise \\Assets\\Menü\_Option1\_Scale-100. png, \\\\Menü\_\_Scale-140. png.
...
-   Fügen Sie für die Featureebene spezifische Ressourcen während der Entwicklung in jedes Ressourcenverzeichnis für Featureebenen ein. Im Gegensatz zu Gebietsschemas und Skalierungsfaktoren können Sie im Spiel für jede Featureebene unterschiedliche Rendercodeverzweigungen verwenden. Falls Sie über Texturen, kompilierte Shader oder andere Ressourcen verfügen, die nur für eine Featureebene oder eine Teilmenge aller unterstützten Featureebenen verwendet werden, fügen Sie die entsprechenden Ressourcen nur in die Verzeichnisse für die Featureebenen ein, von denen sie genutzt werden. Beachten Sie für Ressourcen, die über alle Featureebenen hinweg geladen werden, dass für jedes Featureebenen-Ressourcenverzeichnis davon eine Version gleichen Namens vorhanden ist. Fügen Sie beispielsweise für eine unabhängige Textur auf Featureebene mit dem Namen "coolsign. DDS" die BC3-komprimierte Version in das Verzeichnis \\dxfl-DX9 und die bzw bc7-komprimierte Version im Verzeichnis \\dxfl-DX11 ein.
-   Stellen Sie sicher, dass alle Ressourcen (falls sie für mehrere Featureebenen verfügbar sind) in jedem Verzeichnis denselben Namen haben. Coolsign. DDS sollte z. b. den gleichen Namen sowohl in den \\dxfl-DX9-als auch im \\dxfl-DX11-Verzeichnissen haben, auch wenn der Inhalt der Datei anders ist. In diesem Fall werden Sie als \\dxfl-DX9\\coolsign. DDS und \\dxfl-DX11\\coolsign. DDS angezeigt.
    > **Beachten** Sie   erneut, dass Sie das featurelevel-Suffix optional an den Dateinamen anfügen und im gleichen Verzeichnis speichern können. beispielsweise \\Texturen\\coolsign\_dxfl-DX9. DDS \\Texturen\\coolsign\_dxfl-DX11. DDS.
...
-   Verwenden Sie die APIs in [**Windows.ApplicationModel.Resources.Core**](https://docs.microsoft.com/uwp/api/Windows.ApplicationModel.Resources.Core) zum Laden der Ressourcen. Verweise auf Ressourcen sollten generalisiert werden (kein Suffix), wobei die Featureebene weggelassen wird. Im Gegensatz zu Sprache und Skalierung bestimmt das System jedoch nicht automatisch, welche Featureebene für eine Anzeige optimal ist; dies bestimmen Sie selbst basierend auf Codelogik. Sobald Sie die richtige Ebene bestimmt haben, informieren Sie das Betriebssystem mithilfe der APIs über die bevorzugte Featureebene. Anschließend kann das System basierend auf dieser Einstellung die richtige Ressource abrufen. Dies ist ein Codebeispiel dafür, wie Ihre App über die aktuelle DirectX-Featureebene für die Plattform informiert wird:
    ...
    > **Beachten Sie**  in Ihrem Code die Textur direkt nach dem Namen (oder dem Pfad unterhalb des Verzeichnisses auf Featureebene) laden. Fügen Sie weder den Featureebenen-Verzeichnisnamen noch das Suffix ein. Laden Sie z. b. "Texturen\\coolsign. DDS" und nicht "dxfl-DX11\\Texturen\\coolsign. DDS" oder "Texturen\\coolsign\_dxfl-DX11. DDS".
