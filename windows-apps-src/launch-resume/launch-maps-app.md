...
<div class="alert">
<b>Note</b>  A title can be used for a location if the location is specified by the <b>pos</b> parameter value. Anstatt der Breiten- und Längengrade wird der Titel angezeigt.
</div>
<div>
 
</div></td>
