...
ms.locfileid: "57661895"
---
# <a name="run-a-background-task-on-a-timer"></a>Ausführen einer Hintergrundaufgabe für einen Timer

Hier erfahren Sie, wie Sie mit dem [**TimeTrigger**](https://msdn.microsoft.com/library/windows/apps/br224843) eine einmalige Hintergrundaufgabe planen oder eine regelmäßige Hintergrundaufgabe ausführen.
...
Eine Hintergrundaufgabe wird nur mithilfe eines **TimeTrigger** ausgeführt, wenn Sie zuerst [**RequestAccessAsync**](https://msdn.microsoft.com/library/windows/apps/hh700485) aufgerufen haben.
