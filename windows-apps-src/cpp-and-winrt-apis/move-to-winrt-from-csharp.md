...
|Portieren von Zeichenfolgen|[Verarbeitung von Zeichenfolgen in C++/WinRT](/windows/uwp/cpp-and-winrt-apis/strings)<br>[ToString](/windows/uwp/cpp-and-winrt-apis/move-to-winrt-from-csharp#tostring)<br>[Erstellung von string-Elementen](/windows/uwp/cpp-and-winrt-apis/move-to-winrt-from-csharp#string-building)<br>[Boxing und Unboxing von string-Elementen](/windows/uwp/cpp-and-winrt-apis/move-to-winrt-from-csharp#boxing-and-unboxing-a-string)|
|Typkonvertierung (Typumwandlung)|C#: `o.ToString()`<br>C++/WinRT: `to_hstring(static_cast<int>(o))`<br>Weitere Informationen finden Sie unter [ToString](/windows/uwp/cpp-and-winrt-apis/move-to-winrt-from-csharp#tostring).<br><br>C#: `(Value)o`<br>C++/WinRT: `unbox_value<Value>(o)`<br>Wird ausgelöst, wenn das Unboxing fehlschlägt. Weitere Informationen finden Sie unter [Boxing und Unboxing](/windows/uwp/cpp-and-winrt-apis/boxing).<br><br>C#: `o as Value? ?? fallback`<br>C++/WinRT: `unbox_value_or<Value>(o, fallback)`<br>Gibt ein Fallback zurück, wenn das Unboxing fehlschlägt. Weitere Informationen finden Sie unter [Boxing und Unboxing](/windows/uwp/cpp-and-winrt-apis/boxing).<br><br>C#: `(Class)o`<br>C++/WinRT: `o.as<Class>()`<br>Wird ausgelöst, wenn die Konvertierung fehlschlägt.<br><br>C#: `o as Class`<br>C++/WinRT: `o.try_as<Class>()`<br>Gibt NULL zurück, wenn die Konvertierung fehlschlägt.|
...
|<a name="id_async_action"></a>Asynchrone Aktion|`async Task ...`|`IAsyncAction ...`| [**IAsyncAction**-Schnittstelle](/uwp/api/windows.foundation.iasyncaction), [Parallelität und asynchrone Vorgänge mit C++/WinRT](/windows/uwp/cpp-and-winrt-apis/concurrency) |
|<a name="id_async_operation"></a>Asynchroner Vorgang|`async Task<T> ...`|`IAsyncOperation<T> ...`| [**IAsyncOperation**-Schnittstelle](/uwp/api/windows.foundation.iasyncoperation), [Parallelität und asynchrone Vorgänge mit C++/WinRT](/windows/uwp/cpp-and-winrt-apis/concurrency) |
|<a name="id_fire_and_forget"></a>Fire-and-Forget-Methode (impliziert „Asynchron“)|`async void ...`|`winrt::fire_and_forget ...`|[Portieren der **CopyButton_Click**-Methode](./clipboard-to-winrt-from-csharp.md#copybutton_click), [Fire and Forget (Auslösen und Vergessen)](/windows/uwp/cpp-and-winrt-apis/concurrency-2#fire-and-forget)|
