...
### <a name="coexistence-with-sim-based-nfc-applications"></a>Koexistenz mit SIM-basierten NFC-Anwendungen
...
### <a name="event-notification-when-activation-policy-change"></a>Ereignisbenachrichtigung bei Änderung der Aktivierungsrichtlinie
