...
ms.locfileid: "89157895"
---
# <a name="authentication-and-user-identity"></a>Authentifizierung und Benutzeridentität



Universelle Windows-Plattform-Apps (UWP) verfügen über mehrere Optionen für die Benutzerauthentifizierung, die von einem einfachen Single Sign-on (Single (SSO) über den [Webauthentifizierungs Broker](web-authentication-broker.md) bis hin zu einer äußerst sicheren zweistufigen Authentifizierung reichen.
