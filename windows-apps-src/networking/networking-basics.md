...
-   [**ConnectAsync** ](https://docs.microsoft.com/uwp/api/windows.networking.sockets.streamsocket.connectasync) : Stellen Sie die erste Verbindung mit einem Netzwerkdienst und sofort für die gesamte Kommunikation mit SSL/TLS-Aushandlung.
-   [**UpgradeToSslAsync** ](https://docs.microsoft.com/uwp/api/windows.networking.sockets.streamsocket.upgradetosslasync) -verbinden Sie sich zunächst mit einem Netzwerkdienst ohne Verschlüsselung. Die App kann Daten senden oder empfangen. Dann wird die Verbindung für die Verwendung von SSL/TLS für jede weitere Verbindung hochgestuft.
...
[**ConnectAsync** ](https://docs.microsoft.com/uwp/api/windows.networking.sockets.streamsocket.connectasync) dienen zum Herstellen der anfangsverbindung mit einem Netzwerkdienst, und klicken Sie dann sofort für die gesamte Kommunikation mit SSL/TLS-Aushandlung. Es gibt zwei **ConnectAsync**-Methoden, die das Übergeben eines *protectionLevel*-Parameters unterstützen:

-   [**ConnectAsync (EndpointPair, SocketProtectionLevel)** ](https://docs.microsoft.com/uwp/api/windows.networking.sockets.streamsocket.connectasync) -startet einen asynchronen Vorgang auf einem [ **StreamSocket** ](https://docs.microsoft.com/uwp/api/Windows.Networking.Sockets.StreamSocket) Objekt, das mit einem Remotenetzwerk-Ziel verbinden angegebene als ein [ **EndpointPair** ](https://docs.microsoft.com/uwp/api/Windows.Networking.EndpointPair) Objekt und ein [ **SocketProtectionLevel**](https://docs.microsoft.com/uwp/api/Windows.Networking.Sockets.SocketProtectionLevel).
-   [**ConnectAsync (HostName, String, SocketProtectionLevel)** ](https://docs.microsoft.com/uwp/api/windows.networking.sockets.streamsocket.connectasync) -startet einen asynchronen Vorgang auf einem [ **StreamSocket** ](https://docs.microsoft.com/uwp/api/Windows.Networking.Sockets.StreamSocket) Objekt, das mit einem remote-Ziel verbinden durch einen remote-Hostnamen, ein remotedienstname angegeben und ein [ **SocketProtectionLevel**](https://docs.microsoft.com/uwp/api/Windows.Networking.Sockets.SocketProtectionLevel).
