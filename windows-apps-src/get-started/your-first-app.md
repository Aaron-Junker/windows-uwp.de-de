...
* [Erstellen einer "Hello, World"-app mithilfe von XAML mitC#](create-a-hello-world-app-xaml-universal.md)

Wenn Sie die Grundlagen erlernen oder Ihr Gedächtnis auffrischen möchten, lesen Sie Folgendes:

* [C#Grundlagen für Einsteiger](https://go.microsoft.com/fwlink/?linkid=850801)
...
* [XAML und Datenbindung auf UWP](xaml-basics-intro.md)
* [Eine einfache 2D-UWP-Spiel für den Microsoft Store, geschrieben C# und "MonoGame"](get-started-tutorial-game-mg2d.md)


## <a name="visualc-component-extensions-ccx-and-xaml"></a>Visual C++-komponentenerweiterungen (C++ / CX) und XAML

Profitieren Sie von Ihrer C++-Programmierung Kenntnisse zum Erstellen von apps mithilfe von Visual C++-komponentenerweiterungen (C++ / CX) mit XAML.

* [Erstellen einer "Hello, World"-app mithilfe von XAML mit C++ / CX](create-a-basic-windows-10-app-in-cpp.md)

Weitere Informationen zu C++:

* [C++: Schnelleinstieg in einer Bibliothek und die Sprache für allgemeine Zwecke](https://www.microsoftvirtualacademy.com/training-courses/c-a-general-purpose-language-and-library-jump-start)
...
* [Erstellen einer "Hello, World"-app mithilfe von HTML und JavaScript](create-a-hello-world-app-js-uwp.md)
...
* [Microsoft Edge-Entwicklerdokumentation](https://docs.microsoft.com/microsoft-edge/)
* [Verwenden Sie WebVR mit Microsoft Edge](https://docs.microsoft.com/en-us/microsoft-edge/webvr/)
...
* [Konvertieren Sie Ihre Webanwendung in einer UWP-app](../porting/hwa-create-windows.md)
...
* [HTML5 und CSS3-Grundlagen für Einsteiger](https://www.microsoftvirtualacademy.com/training-courses/html5-css3-fundamentals-development-for-absolute-beginners)
* [Microsoft Virtual Academy](https://go.microsoft.com/fwlink/p/?LinkID=389916)
