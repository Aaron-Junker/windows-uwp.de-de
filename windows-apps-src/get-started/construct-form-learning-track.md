...
* [ComboBox](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Controls.ComboBox) lässt sich erweitern, um eine Liste mit auswählbaren Elementen anzuzeigen. Weitere Informationen dazu erhalten Sie [hier](../design/controls-and-patterns/lists.md#drop-down-lists).
